# Verify/Check Mode for `setup-omskills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-omskills`.
...
- #106 — Feature request: verify/check mode for setup-omskills
