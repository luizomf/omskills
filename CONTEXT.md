...
- Coordinators own candidate disposition. Branch artifacts and recoverable work remain until declared delivery and all integration consumers no longer need them. After verified delivery, remove clean owned worktrees and delete verified-delivered local and remote source branches. A squash-delivered branch is not a target ancestor; its verified source-to-squash mapping authorizes deletion despite that expected lack of ancestry. Preserve unrelated, failed, cancelled, dirty, undelivered, or still-consumed work and record retention reasons.
