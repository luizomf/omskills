...
- Every autonomous one-Ticket or multi-Ticket Mission enters through the **Ticket dispatcher**; a one-Ticket selection becomes a one-item frozen **Mission plan**
...
- The **Ticket dispatcher** starts one fresh **Ticket coordinator** per runnable identity according to the frozen topology; parallel coordinators exist only in a declared compatible group, and the next phase waits for the active group to be delivered
