...
- Ticket breakdown approval includes the proposed sequential/parallel phases. Parallel groups require exclusive Ticket worktrees and branches, shared-resource conflict checks, and a preplanned integration Ticket that combines and verifies the results before dependent work. Each Ticket states its delivery boundary; planning these requirements does not implement them or expand the active harness's capacity.
