...
- **Local markdown** → write one `.scratch/<feature-slug>/tickets.md` file, all tickets in dependency order (blockers first), each with its "Blocked by" listing the titles it depends on. Use the file template below.
