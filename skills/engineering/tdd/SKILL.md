...
3. Resolve each genuinely unconfirmed material seam through the applicable authority branch:
   ...
   - A Mission writer returns the unresolved seam directly to its Ticket coordinator, regardless of Prompt Audit applicability or absolute depth. The writer remains non-delegating and does not route the Question through the dispatcher. The coordinator resolves it with the available maintainer in Assisted work or returns a blocker when Unattended authority cannot resolve it.
