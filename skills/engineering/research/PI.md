...
The worker brief must state that it is the delegated researcher and must perform the research directly, without invoking `research` or delegating again. This prevents recursive workers.
