...
- **`docs/adr/`** — read ADRs that touch the area you're about to work in. In multi-context repos, also check `docs/adr/` within each relevant context located through `CONTEXT-MAP.md`.
