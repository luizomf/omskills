...
- **[deep-coder](./deep-coder/SKILL.md)** — Experimental serial GitHub PR loop for ready-for-agent issues, using fresh Coder/Reviewer contexts and Orchestrator gates.
