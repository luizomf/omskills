...
- **[setup-ts-deep-modules](./setup-ts-deep-modules/SKILL.md)** - Experimental TypeScript package-boundary setup using dependency-cruiser; not part of the plugin manifests.
