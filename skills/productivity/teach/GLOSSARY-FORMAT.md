...
- **Add a term only when the user understands it.** If the user has just been introduced to a concept, wait until they can use it correctly before promoting it here.
...
- **Revise as understanding deepens.** Update in place.
