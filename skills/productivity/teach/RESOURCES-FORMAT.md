...
- **Annotate every entry.** Add one line: what it covers and when to reach for it.
...
- **Community opt-out belongs in `NOTES.md`.** If the user has opted out of joining communities, record it in `NOTES.md`, not here.
