...
| --- | --- | --- | --- |
| Mechanical edits, extraction, formatting, transcript cleanup, short grounded summaries | GPT-5.6 Luna — xhigh | Claude Sonnet 5 — low | Gemini 3.8 Flash — low |
| Bounded code/test implementation with settled design and clear acceptance checks | GPT-5.6 Sol — low | Claude Sonnet 5 — high | Gemini 3.8 Flash — medium |
| Thin dispatch of an already resolved plan, without implementation decisions | GPT-5.6 Sol — low | Claude Sonnet 5 — medium | Gemini 3.8 Flash — low |
...
| Ambiguous architecture, difficult cross-system trade-offs, or complex integration decisions | GPT-5.6 Sol — high | Claude Fable 5.1 — high | Gemini 3.8 Flash — high; evaluate on the workload |
...
- GPT-5.6 Luna/Sol support API `reasoning.effort` values `none`, `low`,
